...
class Musers extends CI_Model {
    ...
    function showuserLmod() {
        $this->db->where('tag', 'local_moderators');
        $data = $this->db->get('admin');
        if ($data->num_rows() > 0) {
            return $data->result_array();
        } else {
    ...
    function showuserUser() {
        $this->db->where('tag', 'user');
        $data = $this->db->get('admin');
        if ($data->num_rows() > 0) {
            return $data->result_array();
        } else {
    ...
    function permission_add() {
        ...
        $data = array(
			...
			'ac_website_comment' => $this->input->post('ac_website_comment'),
			'ac_writers_column' => $this->input->post('ac_writers_column'),
			'ac_special_event' => $this->input->post('ac_special_event'),
			'ac_print_news' => $this->input->post('ac_print_news'),
