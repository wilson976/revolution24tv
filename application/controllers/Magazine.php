...
class Magazine extends CI_Controller {
    ...
    //     $data = array();
    //     $data['class'] = 'mag-home';
    //     $data['magazine'] = $this->Model_mag->getMagazine();
    ...
    function index() {
        ...
        $data['class'] = 'mag-home';
        $data['magazine'] = $this->File_model->read_file('Mag_Home');
    ...
    //     $mdt = $y . '-' . $m . '-' . $d;
    //     $data = array();
    //     $data['class'] = 'mag-pagesnews';
    //     $data['mdt'] = $mdt;
    //     $data['getmenu'] = $this->Model_menu->getCategory($m_name);
    //     $data['category_leadnews'] = $this->Model_mag->getCategoryLeadNews($data['getmenu']['m_id']);
    //     $data['more_news'] = $this->Model_mag->getCategoryNews($data['getmenu']['m_id'], $data['category_leadnews']['n_id']);
