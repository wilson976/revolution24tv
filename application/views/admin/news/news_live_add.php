<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <?php echo form_open_multipart('admin/news/add_live/' . $news_id, 'class="form-horizontal"'); ?>          
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea name="n_head_live"></textarea>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea name="n_details_live" id="maineditor" class="n_details"></textarea>
                    </div>
                </div>
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-folder-open"></i> List</h2>
            <div class="box-icon">                
                <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>                
            </div>
        </div>
                ...
                <tbody>
                    ...
                    if ($livelist != NULL) {
                        ...
                        foreach ($livelist as $row):
                            ...
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td class="center"><?php echo strip_tags($row['new_details']); ?></td>
                                <td class="center"><?php echo  timedifference($row['post_time']);?> আগে</td>
                                <td class="center"><?php echo $row['u_name']?></td>
                                <td class="center">
                                    <a href="admin/news/edit_live/<?php echo $edit_data['n_id']; ?>/<?php echo $row['l_id']; ?>">
                                        <span class="label label-warning"><i class="icon-edit icon-white"></i>Edit</span>                                    </a>       

                                    <a href="admin/news/lndelete/<?php echo $row['l_id']; ?>/<?php echo $edit_data['n_id']; ?>" onclick="return deletechecked();">
