<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <?php echo form_open('admin/sort_news/arrangeCatNewsUpdate/', 'class="form-horizontal"'); ?>            
            <fieldset> 

                <?php
                $i = 1;
                $row_count = count($slidercatnews);
                // echo $row;
                if ($slidercatnews != NULL) {
                    ?>
                    <table class="control-group">
                    <?php
                    foreach ($slidercatnews as $newsslider) {
                        ?><tr>
				...
				?>
                            ...
                            <?php  if($i!=$row_count){ ?>
                                ...
                                <input name="n_order[]" type="text" style="width: 100px;" class="input-xlarge focused sort" id="<?php echo 'n_order' . $i ?>" value="<?php  echo $newsslider['cat_slide']; ?>">
                            </div>                            
                            <?php

                            echo form_hidden('n_id' . $i, $newsslider['n_id']);
                           echo form_hidden('n_category', $n_category);
                            ?></td>
