<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <?php echo form_open('admin/sort_news/orderupdate_slider/', 'class="form-horizontal"'); ?>            
            <fieldset> 
				...
				?>
                            ...
                            <?php  if($i!=$row_count){ ?>
                                ...
                                <input name="n_order[]" type="text" style="width: 100px;" class="input-xlarge focused sort" id="<?php echo 'n_order' . $i ?>" value="<?php echo $newsslider[$order]; ?>">
                            </div>                            
                            <?php
