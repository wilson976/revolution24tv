                        ...
                        <div class="DBdTop">
                            <a href="<?php echo findWorkbleMenu($politics[0]['n_category']); ?>/<?php echo str_replace('-', '/', $politics[0]['n_date']) ?>/<?php echo $politics[0]['n_id']; ?>">
                                <div class="DImgZoomBlock">
                                    <picture>
                                        <img src="<?php echo './assets/news_images/'.str_replace('-','/',$politics[0]['n_date']).'/' . $politics[0]['main_image']; ?>" alt="<?php echo $politics[0]['n_head'];?>" title="<?php echo $politics[0]['n_head'];?>" class="img-fluid">
                                    </picture>
                                    <?php
                                ...
                                <div class="Desc">
                                    ...
                                    <div class="Brief">
                                        <p><?php echo splitText(strip_tags($politics[0]['n_details']), 480); ?></p>
                                    </div>
                                </div>
                            </a>
                        </div>
