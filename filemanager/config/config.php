...
|    |   |   |   |   |- plugin.min.js
*/
$Hello_NB_File_manager = date('m').'67rtfvoaea47dd75a98304083ec2fcf624aa783'.date('y');
$config = array(
    ...
    |
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://www.globalnews.com.bd",
    /*
    |--------------------------------------------------------------------------
