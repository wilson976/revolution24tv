...
Xteam.firework=function(a){
    ...
    var j={
    draw:e
},l=a.getContext(),n=Xteam.FireworkParticle,h=70,k,i,m,o,f;
c();
return j
};
...
Xteam.Canvas.scene=function(a){
    ...
    getCanvas:n,
    destroy:j
},k=a.getContext("2d"),i=[],m=[],o=setInterval(function(){
...
Xteam.Color.hslToRgb.test=function(){
    function a(e,d){
        for(var j=e.lenght;j--;)if(e[j]!==d[j])throw Error("Got "+e+", expected "+d);console.log("success")
        }
