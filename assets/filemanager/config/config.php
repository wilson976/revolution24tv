...
// if($MyipAddress == '192.168.50.101' || $MyipAddress == '163.53.182.113' || $MyipAddress == '::1'){
...
|    |   |   |   |   |- plugin.min.js
*/
$Hello_NB_File_manager = '67rtfvoaea47dd75a98304083ec2fcf624aa783'.date('y');
$config = array(
    ...
    |
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://www.revolution24.tv",
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    // 'upload_dir' => '/assets/kcimages/images/2021/',
    'upload_dir' => '/assets/kcimages/images/2024/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    // 'current_path' => '../assets/kcimages/images/2021/',
    'current_path' => '../kcimages/images/2024/',
    ...
    */
    ...
    // 'access_keys' => array(),
    'access_keys' => array('myPrivateKey', $Hello_NB_File_manager ),
